...
export default function RestorePdf({selectedPDF}) {
    ...
    const onSubmit = async (ev) => {
        ...
        try {
          const response = await axiosClient.put(`/restorepdf/${selectedPDF}`);
  ...
  return (
    <div className='text-center'>
      ...
      <h1>
        Are you sure you want to Restore <b>{selectedPDF}</b>?
      </h1>
